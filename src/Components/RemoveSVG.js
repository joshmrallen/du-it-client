...
export default class RemoveSVG extends React.Component {
    render(){
        const { size } = this.props

        return(
            <svg onClick={this.props.clickHandler} width={size} height={size} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 294.843 294.843" styles="enable-background:new 0 0 294.843 294.843;" xmlSpace="preserve">
<g>
